...
use Storage;
class BulkGenerateIndividualCard extends BulkAction
{
    ...
    public static function make(?string $name = null): static
    {
        ...
        return parent::make('generateIndividualCard')
            ->label('Generuj Kartę Indywidualną Masowo')
            ->form([
                Wizard::make([
                ...
                foreach ($chunks as $chunk) {
                    ...
                    foreach ($chunk as $record) {
                        ...
                        foreach ($values as $key => $value) {
                            if (!preg_match('/^$|nie dotyczy|#N\/A/', $value)) {
                                $fields[] = $key;
                            }
                        }
                        ...
                        $jobs[] = new GenerateIndividualCardJob($record, $data, auth()->user());
                        $count++;
                    }
